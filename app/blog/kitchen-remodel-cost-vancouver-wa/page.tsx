...
export const metadata: Metadata = {
	...
	alternates: {
		canonical: "https://www.norbilt.com/blog/kitchen-remodel-cost-vancouver-wa",
	},
	openGraph: {
		title: "Kitchen Remodel Cost in Vancouver WA: 2026 Pricing Guide | NORBILT",
		description:
		...
		url: "https://www.norbilt.com/blog/kitchen-remodel-cost-vancouver-wa",
		siteName: "NORBILT",
		type: "article",
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						mainEntityOfPage: "https://www.norbilt.com/blog/kitchen-remodel-cost-vancouver-wa",
					}),
				}}
			/>
			<script
				...
				dangerouslySetInnerHTML={{ __html: JSON.stringify({
					...
					itemListElement: [
						...
						{ "@type": "ListItem", position: 3, name: "Kitchen Remodel Cost in Vancouver WA: 2026 Pricing Guide", item: "https://www.norbilt.com/blog/kitchen-remodel-cost-vancouver-wa" },
					],
				}) }}
			/>
			...
			<div className="overflow-hidden bg-[#FDFCFB]">
				...
				<div className="max-w-3xl mx-auto px-6 pb-8">
					<div className="bg-[#1F2E2B] rounded-2xl p-8 text-center">
						...
						<h3 className="text-xl font-black text-white mb-3">Ready to Start Your Kitchen Remodel?</h3>
						...
						<div className="flex flex-wrap justify-center gap-3">
							<Link href="/services/kitchen-remodel" className="inline-flex items-center gap-2 bg-[#FFB800] text-black px-6 py-3 rounded-xl font-black uppercase tracking-widest text-sm hover:scale-105 transition-all">Kitchen Remodel Services</Link>
