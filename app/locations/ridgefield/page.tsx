...
export default function RidgefieldLocationPage() {
	return (
			...
			<section className="pt-32 pb-28 bg-[#2C3E3A]">
				<div className="max-w-6xl mx-auto px-6 text-center">
					...
					>
						...
						Premium Home Repair & Finish Carpentry in Ridgefield, WA
					</motion.span>
					...
					>
						Ridgefield Handyman & Home Repair | Interior Experts
					</motion.h1>
					...
					>
						...
						meticulous home maintenance for homeowners across Ridgefield and
						surrounding areas.
					</motion.p>
				</div>
			</section>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						<div className="space-y-6">
							<h2 className="text-3xl md:text-4xl font-semibold text-[#2C3E3A]">
								Elevating the Standard of Ridgefield Home Maintenance
							</h2>
							<p className="text-lg text-[#2C3E3A]/80 leading-relaxed">
								Ridgefield is defined by its beautiful landscapes and quality
								homes. Whether you own a home near{" "}
								<strong>Discovery Ridge</strong> or in{" "}
								<strong>Pioneer Canyon</strong>, maintaining that standard
								requires a contractor who values precision over speed.
							</p>
							<p className="text-lg text-[#2C3E3A]/80 leading-relaxed">
								At <strong>Norbilt Homes</strong>, we specialize in the details
								that keep Ridgefield homes pristine. From{" "}
				...
				<div className="max-w-6xl mx-auto px-6">
					<div className="text-center mb-16">
						<h2 className="text-3xl md:text-4xl font-semibold text-[#2C3E3A] mb-4">
							Ridgefield Home Improvement Services
						</h2>
					...
					<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								href: "/locations/ridgefield/flooring",
							},
						].map((service) => (
							<Link
								key={service.name}
			...
			<section className="py-28 bg-[#2C3E3A] text-center relative overflow-hidden">
				<div className="relative z-10 px-6">
					<h2 className="text-3xl md:text-5xl font-semibold text-[#F8F6F3] mb-6">
						Ready to Start Your Ridgefield Project?
					</h2>
					...
					<div className="mt-12 flex justify-center flex-wrap gap-6 text-[#F8F6F3]/40 text-sm font-medium">
						<span>Discovery Ridge</span>
						<span>Pioneer Canyon</span>
						<span>Abrams Park</span>
						<span>Junction</span>
					</div>
				</div>
			</section>
