...
const drivers = [
	...
	{ title: "Permits in Ridgefield", body: "City of Ridgefield permit requirements follow Clark County guidelines. Cosmetic work — counters, backsplash, hardware, lighting swaps at existing boxes — typically doesn't require a permit. Plumbing relocation, electrical panel work, and structural changes do. NORBILT (WA Lic. NORBIHH849QC) handles all permits." },
];
...
const faqs = [
	...
	{ q: "Do I need a permit for a kitchen remodel in Ridgefield WA?", a: "Cosmetic work — new counters, backsplash, hardware, and lighting swaps at existing boxes — typically doesn't require a permit. Plumbing relocation, electrical panel work, and structural changes do. NORBILT (WA Lic. NORBIHH849QC) pulls all required permits." },
				...
				<article className="py-16 lg:py-24">
					<div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-16">
						<section className="space-y-5 text-gray-700 leading-relaxed text-lg">
							...
							<p>NORBILT is a licensed general contractor (WA Lic. <strong>NORBIHH849QC</strong>) serving Ridgefield and all of Clark County. We carry $1,000,000 liability insurance and back all kitchen work with a 1-year workmanship warranty.</p>
						</section>
						...
						<section className="bg-[#1F2E2B] rounded-3xl p-10 space-y-5">
							...
							<ul className="space-y-3">{["WA General Contractor License NORBIHH849QC", "$1,000,000 liability insurance on every job", "Bonded — protects you if work is incomplete", "We pull all required permits", "1-year workmanship warranty on all kitchen work"].map((item, i) => (<li key={i} className="flex items-start gap-3 text-white/80 text-sm"><CheckCircle2 className="w-4 h-4 text-[#FFB800] mt-0.5 shrink-0" />{item}</li>))}</ul>
						</section>
