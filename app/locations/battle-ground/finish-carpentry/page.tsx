...
export const metadata = {
	title: "Finish Carpentry Battle Ground WA (98604) | Custom Trim & Millwork | Norbilt",
	description:
		"Custom finish carpentry in Battle Ground, WA 98604. Crown molding, wainscoting, board & batten, baseboards, and precision millwork installation. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/battle-ground/finish-carpentry",
	},
	openGraph: {
		title: "Battle Ground Finish Carpentry | Custom Trim & Millwork 98604",
		description:
			"Architectural trim and detailed millwork for Battle Ground homeowners.",
		type: "website",
		images: [
			{
...
export default function BattleGroundFinishCarpentryPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Custom crown molding and millwork installation in Battle Ground WA 98604"
					fill
					priority
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					...
					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From homes in Meadow Glade to properties in Lewisville, we design
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Battle Ground Finish Carpentry Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
							<Image
								...
								alt="Custom trim and wainscoting in Battle Ground Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We provide finish carpentry services throughout Battle Ground, including
			...
			<section className="py-24 bg-white">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Battle Ground Finish Carpentry FAQs
					</h2>
