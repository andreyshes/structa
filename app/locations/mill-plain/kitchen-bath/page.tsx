...
export const metadata = {
	title: "Kitchen & Bathroom Remodeling Mill Plain WA (98684) | Norbilt",
	description:
		"Premium kitchen and bathroom updates in Mill Plain, WA 98684. Designer fixture upgrades, backsplash installation, cabinet refinements, and luxury finish improvements without full demolition.",
	alternates: {
		canonical: "https://norbilt.com/locations/mill-plain/kitchen-bath",
	},
	openGraph: {
		title: "Mill Plain Kitchen & Bathroom Updates | 98684 Remodeling",
		description: "Refined kitchen and bath modernization for Mill Plain homeowners.",
		type: "website",
		images: [
			{
...
export default function MillPlainKitchenBathPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Luxury kitchen remodel update in Mill Plain Washington 98684"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">Updates in Mill Plain</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Mill Plain Kitchen & Bath Modernization Specialists
					</h2>

					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From Mill Plain homes to surrounding properties, we
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Mill Plain Kitchen & Bathroom Upgrade Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
							<Image
								...
								alt="Bathroom upgrade in Mill Plain Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We serve Mill Plain neighborhoods including Fourth Plain, Hough, Central Park, and surrounding Clark County areas.
					</p>
			...
			<section className="py-24 bg-white">
				<div className="max-w-5xl mx-auto px-6">
					...
					<div className="space-y-10">
						...
						<div>
							<h3 className="font-semibold text-lg">
								Do you serve all of Mill Plain?
							</h3>
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. We serve Mill Plain (98684) and surrounding Clark County
								neighborhoods.
							</p>
						</div>
					</div>
