...
export const metadata = {
	title: "Flooring & Subfloor Repair Ridgefield WA (98642) | Norbilt",
	description:
		"Professional flooring repair in Ridgefield, WA 98642. Fix squeaky floors, uneven subfloors, moisture damage, and hardwood or LVP transitions. Licensed & insured. Free estimates.",
	alternates: {
		canonical: "https://norbilt.com/locations/ridgefield/flooring",
	},
	openGraph: {
		title: "Ridgefield Flooring Repair | Subfloor & Leveling 98642",
		description:
			"Expert floor leveling, squeak repair, and structural flooring corrections for Ridgefield homeowners.",
		type: "website",
		images: [
			{
...
export default function RidgefieldFlooringPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Hardwood and subfloor repair in Ridgefield Washington 98642"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						Flooring & Subfloor
						<span className="block text-[#A5D6A7]">Repair in Ridgefield</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Structural Flooring Corrections for 98642 Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Ridgefield homes — particularly those in Abrams Park and Discovery Ridge —
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Ridgefield Flooring Repair Services
					</h2>
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide flooring repair services throughout Ridgefield, including
						Abrams Park, Discovery Ridge, Pioneer Canyon, and surrounding Clark
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Ridgefield Flooring FAQs
					</h2>

					<div className="space-y-10">
						<div>
							<h3 className="font-semibold text-lg">
								Why do floors squeak in Ridgefield homes?
							</h3>
