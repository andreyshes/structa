...
export default function OrchardsLocationPage() {
	return (
			...
			<section className="pt-32 pb-28 bg-[#2C3E3A]">
				<div className="max-w-6xl mx-auto px-6 text-center">
					...
					>
						...
						Premium Home Repair & Finish Carpentry in Orchards, WA
					</motion.span>
					...
					>
						Orchards Handyman & Home Repair | Interior Experts
					</motion.h1>
					...
					>
						...
						meticulous home maintenance for homeowners across Orchards and
						surrounding areas.
					</motion.p>
				</div>
			</section>
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						<div className="space-y-6">
							<h2 className="text-3xl md:text-4xl font-semibold text-[#2C3E3A]">
								Elevating the Standard of Orchards Home Maintenance
							</h2>
							<p className="text-lg text-[#2C3E3A]/80 leading-relaxed">
								Orchards is a vibrant community with diverse housing styles.
								Whether you own a home in <strong>Minnehaha</strong> or near{" "}
								<strong>Orchards Heights</strong>, maintaining that standard
								requires a contractor who values precision over speed.
							</p>
							<p className="text-lg text-[#2C3E3A]/80 leading-relaxed">
								At <strong>Norbilt Homes</strong>, we specialize in the details
								that keep Orchards homes pristine. From{" "}
				...
				<div className="max-w-6xl mx-auto px-6">
					<div className="text-center mb-16">
						<h2 className="text-3xl md:text-4xl font-semibold text-[#2C3E3A] mb-4">
							Orchards Home Improvement Services
						</h2>
			...
			<section className="py-28 bg-[#2C3E3A] text-center relative overflow-hidden">
				<div className="relative z-10 px-6">
					<h2 className="text-3xl md:text-5xl font-semibold text-[#F8F6F3] mb-6">
						Ready to Start Your Orchards Project?
					</h2>
					...
					<div className="mt-12 flex justify-center flex-wrap gap-6 text-[#F8F6F3]/40 text-sm font-medium">
						<span>Minnehaha</span>
						<span>Orchards Heights</span>
						<span>Orchards North</span>
						<span>Southeast Orchards</span>
					</div>
				</div>
			</section>
		</div>
