...
export const metadata = {
	title:
		"Door & Window Repair Brush Prairie WA (98606) | Alignment & Draft Fix | Norbilt",
	description:
		"Professional door and window repair in Brush Prairie, WA 98606. Fix sticking doors, eliminate drafts, replace weatherstripping, and repair locks or frame alignment. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/brush-prairie/door-window",
	},
	openGraph: {
		title: "Brush Prairie Door & Window Repair | 98606 Alignment & Draft Fix",
		description:
			"Precision door adjustments, draft sealing, and hardware repair for Brush Prairie homeowners.",
		type: "website",
		images: [
			{
...
export default function BrushPrairieDoorWindowPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Door alignment and window sealing repair in Brush Prairie WA 98606"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<p className="text-xl mb-10 text-white/90 max-w-2xl mx-auto">
						...
						for acreage and custom homes throughout 98606.
					</p>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Precision Adjustments for 98606 Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Seasonal expansion, rural exposure, and minor foundation movement
						can cause doors to drag and windows to leak air. We properly realign
						frames and install high-quality weatherstripping for long-term
						performance.
					</p>
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Brush Prairie Door & Window Services
					</h2>
					...
					<div className="grid md:grid-cols-3 gap-8 text-center">
						...
						<div className="p-8 rounded-2xl bg-white shadow-sm hover:shadow-lg transition group">
							...
							<p className="text-sm text-[#2C3E3A]/70">
								Install or repair deadbolts, smart locks, and handle-sets with
								precision.
							</p>
						</div>
					</div>
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide door and window repair throughout Brush Prairie,
