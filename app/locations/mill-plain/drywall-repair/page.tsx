...
export const metadata = {
	title:
		"Drywall Repair Mill Plain WA (98684) | Texture Matching & Ceiling Repair | Norbilt",
	description:
		"Professional drywall repair in Mill Plain, WA 98684. We patch holes, repair cracks, fix ceiling water damage, and match Orange Peel or Knockdown textures with seamless results.",
	alternates: {
		canonical: "https://norbilt.com/locations/mill-plain/drywall-repair",
	},
	openGraph: {
		title: "Mill Plain Drywall Repair & Texture Matching | 98684",
		description:
			"Invisible drywall patching and ceiling repair for Mill Plain homeowners.",
		type: "website",
		images: [
			{
...
export default function MillPlainDrywallRepairPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Professional drywall patching and ceiling repair in Mill Plain WA 98684"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<p className="text-xl md:text-2xl mb-10 text-white/90 max-w-2xl mx-auto">
						...
						ceiling restoration for 98684 homes.
					</p>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Precision Texture Matching for Mill Plain Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Many Mill Plain properties feature Orange Peel or Knockdown textures. Our
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6 text-center">
					<h2 className="text-4xl font-bold mb-14">
						Texture Matching Services in 98684
					</h2>
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								icon: Paintbrush,
								desc: "Hand-finished texture common in Mill Plain homes.",
							},
							{
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide drywall repair throughout Mill Plain, including Fourth Plain, Hough, Central Park, and surrounding Clark County
						neighborhoods.
					</p>
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Mill Plain Drywall Repair FAQs
					</h2>
