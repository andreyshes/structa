...
export const metadata = {
	title: "Professional Handyman Services Felida WA (98660) | Norbilt",
	description:
		"Reliable handyman services in Felida, WA 98660. Drywall repair, trim work, door adjustments, fixture installation, and general home maintenance. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/felida/handyman",
	},
	openGraph: {
		title: "Felida Handyman Services | 98660 Home Repairs",
		description:
			"Detail-oriented handyman repairs and home maintenance for Felida homeowners.",
		type: "website",
		images: [
			{
...
export default function FelidaHandymanPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Professional handyman working in Felida Washington 98660"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">Services in Felida</span>
					</h1>

					<p className="text-xl md:text-2xl text-white/90 mb-10 max-w-2xl mx-auto">
						Detail-oriented repairs and maintenance for Felida homeowners. Clean
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We serve Felida neighborhoods including Salmon Creek, Rosemont, Lake Shore, and surrounding Clark County communities.
					</p>
					...
					<div className="space-y-10">
						<div>
							...
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. We provide handyman services throughout Felida (98660) and
