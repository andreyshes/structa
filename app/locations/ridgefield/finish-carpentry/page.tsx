...
export const metadata = {
	title: "Finish Carpentry Ridgefield WA (98642) | Custom Trim & Millwork | Norbilt",
	description:
		"Custom finish carpentry in Ridgefield, WA 98642. Crown molding, wainscoting, board & batten, baseboards, and precision millwork installation. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/ridgefield/finish-carpentry",
	},
	openGraph: {
		title: "Ridgefield Finish Carpentry | Custom Trim & Millwork 98642",
		description:
			"Architectural trim and detailed millwork for Ridgefield homeowners.",
		type: "website",
		images: [
			{
...
export default function RidgefieldFinishCarpentryPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Custom crown molding and millwork installation in Ridgefield WA 98642"
					fill
					priority
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					...
					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From homes in Abrams Park to properties in Discovery Ridge, we design
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Ridgefield Finish Carpentry Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
							<Image
								...
								alt="Custom trim and wainscoting in Ridgefield Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We provide finish carpentry services throughout Ridgefield, including
			...
			<section className="py-24 bg-white">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Ridgefield Finish Carpentry FAQs
					</h2>
