...
export const metadata = {
	title: "Finish Carpentry Camas WA (98607) | Custom Trim & Millwork | Norbilt",
	description:
		"Custom finish carpentry in Camas, WA 98607. Crown molding, wainscoting, board & batten, baseboards, and precision millwork installation. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/camas/finish-carpentry",
	},
	openGraph: {
		title: "Camas Finish Carpentry | Custom Trim & Millwork 98607",
		description:
			"Architectural trim and detailed millwork for Camas homeowners.",
		type: "website",
		images: [
			{
...
export default function CamasFinishCarpentryPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Custom crown molding and millwork installation in Camas WA 98607"
					fill
					priority
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					...
					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From homes near Lacamas Lake to properties in Prune Hill, we design
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Camas Finish Carpentry Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
							<Image
								...
								alt="Custom trim and wainscoting in Camas Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We provide finish carpentry services throughout Camas, including
