...
export const metadata = {
	title: "Kitchen & Bathroom Remodeling Ridgefield WA (98642) | Norbilt",
	description:
		"Premium kitchen and bathroom updates in Ridgefield, WA 98642. Designer fixture upgrades, backsplash installation, cabinet refinements, and luxury finish improvements without full demolition.",
	alternates: {
		canonical: "https://norbilt.com/locations/ridgefield/kitchen-bath",
	},
	openGraph: {
		title: "Ridgefield Kitchen & Bathroom Updates | 98642 Remodeling",
		description: "Refined kitchen and bath modernization for Ridgefield homeowners.",
		type: "website",
		images: [
			{
...
export default function RidgefieldKitchenBathPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Luxury kitchen remodel update in Ridgefield Washington 98642"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">Updates in Ridgefield</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Ridgefield Kitchen & Bath Modernization Specialists
					</h2>

					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From homes in Abrams Park to properties in Discovery Ridge, we
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Ridgefield Kitchen & Bathroom Upgrade Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
							<Image
								...
								alt="Bathroom upgrade in Ridgefield Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We serve Ridgefield neighborhoods including Abrams Park, Discovery Ridge,
						Pioneer Canyon, and surrounding Clark County areas.
					</p>
				...
				<div className="max-w-5xl mx-auto px-6">
					...
					<div className="space-y-10">
						...
						<div>
							...
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. We serve Ridgefield (98642) and surrounding Clark County
								neighborhoods.
							</p>
						</div>
					</div>
