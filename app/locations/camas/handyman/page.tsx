...
export const metadata = {
	title: "Professional Handyman Services Camas WA (98607) | Norbilt",
	description:
		"Reliable handyman services in Camas, WA 98607. Drywall repair, trim work, door adjustments, fixture installation, and general home maintenance. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/camas/handyman",
	},
	openGraph: {
		title: "Camas Handyman Services | 98607 Home Repairs",
		description:
			"Detail-oriented handyman repairs and home maintenance for Camas homeowners.",
		type: "website",
		images: [
			{
...
export default function CamasHandymanPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Professional handyman working in Camas Washington 98607"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">Services in Camas</span>
					</h1>

					<p className="text-xl md:text-2xl text-white/90 mb-10 max-w-2xl mx-auto">
						Detail-oriented repairs and maintenance for Camas homeowners. Clean
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We serve Camas neighborhoods including Downtown Camas, Prune Hill,
						Lacamas Lake, and surrounding Clark County communities.
					</p>
					...
					<div className="space-y-10">
						<div>
							...
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. We provide handyman services throughout Camas (98607) and
