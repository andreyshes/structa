...
const drivers = [
	...
	{ title: "Permits Follow Clark County Requirements", body: "Cosmetic remodels — vanity, tile, fixtures, paint — typically don't require a permit. Plumbing relocation, structural changes, and electrical panel work do. NORBILT (WA Lic. NORBIHH849QC) handles all permits." },
];
const neighborhoods = [
...
const faqs = [
	...
	{ q: "Do I need a permit for a bathroom remodel in Battle Ground?", a: "Cosmetic remodels — new vanity, tile, fixtures, and paint — typically don't require a permit. Plumbing relocation, structural changes, and electrical panel work do. NORBILT (WA Lic. NORBIHH849QC) handles all required permits." },
