...
const drivers = [
	...
	{ title: "Permits Follow Clark County Requirements", body: "Battle Ground follows Clark County permit requirements. Cosmetic work typically doesn't require a permit. Plumbing relocation, electrical panel work, and structural changes do. NORBILT (WA Lic. NORBIHH849QC) handles all permits." },
];
const neighborhoods = [
...
const faqs = [
	...
	{ q: "Do I need a permit for a kitchen remodel in Battle Ground?", a: "Cosmetic work — counters, backsplash, hardware, lighting at existing boxes — typically doesn't require a permit. Plumbing relocation, gas line work, and electrical panel changes do. NORBILT (WA Lic. NORBIHH849QC) handles all required permits." },
...
export default function KitchenRemodelCostBattleGroundWA() {
	return (
		<>
			<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BlogPosting", headline: "Kitchen Remodel Cost in Battle Ground WA: 2026 Guide", author: { "@id": "https://www.norbilt.com/#founder" }, publisher: { "@id": "https://www.norbilt.com/#organization" }, datePublished: "2026-06-08", dateModified: "2026-06-08", mainEntityOfPage: "https://www.norbilt.com/blog/kitchen-remodel-cost-battle-ground-wa" }) }} />
			<script
				...
				<article className="py-16 lg:py-24">
					<div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-16">
						<section className="space-y-5 text-gray-700 leading-relaxed text-lg">
							...
							<p>NORBILT is a licensed general contractor (WA Lic. <strong>NORBIHH849QC</strong>) — one of the most active licensed contractors serving Battle Ground and north Clark County. $1,000,000 liability insurance. 1-year workmanship warranty on all kitchen work.</p>
						</section>
