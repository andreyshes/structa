...
export const metadata = {
	title:
		"Door & Window Repair Orchards WA (98662) | Draft & Alignment Fix | Norbilt",
	description:
		"Professional door and window repair in Orchards, WA 98662. Fix sticking doors, drafts, weatherstripping, lock issues, and frame misalignment. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/orchards/door-window",
	},
	openGraph: {
		title: "Orchards Door & Window Repair | 98662 Alignment & Draft Fix",
		description:
			"Precision door adjustments, window sealing, and hardware repair for Orchards homeowners.",
		type: "website",
		images: [
			{
...
export default function OrchardsDoorWindowPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Door alignment and window sealing repair in Orchards Washington 98662"
					fill
					priority
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Precision Adjustments for 98662 Homes
					</h2>
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide door and window repair throughout Orchards, including
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Orchards Door & Window FAQs
					</h2>

					<div className="space-y-10">
						<div>
							<h3 className="font-semibold text-lg">
								Why do doors stick in Orchards homes?
							</h3>
