...
export const metadata = {
	title: "Kitchen & Bathroom Remodeling Battle Ground WA (98604) | Norbilt",
	description:
		"Premium kitchen and bathroom updates in Battle Ground, WA 98604. Designer fixture upgrades, backsplash installation, cabinet refinements, and luxury finish improvements without full demolition.",
	alternates: {
		canonical: "https://norbilt.com/locations/battle-ground/kitchen-bath",
	},
	openGraph: {
		title: "Battle Ground Kitchen & Bathroom Updates | 98604 Remodeling",
		description: "Refined kitchen and bath modernization for Battle Ground homeowners.",
		type: "website",
		images: [
			{
...
export default function BattleGroundKitchenBathPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Luxury kitchen remodel update in Battle Ground Washington 98604"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">Updates in Battle Ground</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Battle Ground Kitchen & Bath Modernization Specialists
					</h2>

					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From homes in Meadow Glade to properties in Lewisville, we
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Battle Ground Kitchen & Bathroom Upgrade Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
							<Image
								...
								alt="Bathroom upgrade in Battle Ground Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We serve Battle Ground neighborhoods including Meadow Glade, Lewisville,
						Dollars Corner, and surrounding Clark County areas.
					</p>
			...
			<section className="py-24 bg-white">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Battle Ground Kitchen & Bath FAQs
					</h2>
					...
					<div className="space-y-10">
						...
						<div>
							<h3 className="font-semibold text-lg">
								Do you serve all of Battle Ground?
							</h3>
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. We serve Battle Ground (98604) and surrounding Clark County
								neighborhoods.
							</p>
						</div>
					</div>
