					...
					<div className="grid lg:grid-cols-2 gap-20 items-center">
						<div className="space-y-8">
							<h2 className="text-4xl lg:text-5xl font-black text-[#1F2E2B] uppercase tracking-tighter leading-none">
								Licensed Home Repair Contractor <br />
					...
					<div className="mt-16 space-y-6">
						{[
							...
							},
							{
								...
								a: "Based on 2026 Clark County rates: minor repairs (faucet, toilet, caulking, hardware) run $175–$400, mid-scope repairs (door replacement, drywall water damage, fixture upgrade) $345–$800, and larger repair punch lists $575–$1,500+. We provide a free written estimate before any work starts — no surprises.",
							},
							{
