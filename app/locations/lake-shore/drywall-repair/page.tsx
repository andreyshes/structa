...
export const metadata = {
	title:
		"Drywall Repair Lake Shore WA (98660) | Texture Matching & Ceiling Repair | Norbilt",
	description:
		"Professional drywall repair in Lake Shore, WA 98660. We patch holes, repair cracks, fix ceiling water damage, and match Orange Peel or Knockdown textures with seamless results.",
	alternates: {
		canonical: "https://norbilt.com/locations/lake-shore/drywall-repair",
	},
	openGraph: {
		title: "Lake Shore Drywall Repair & Texture Matching | 98660",
		description:
			"Invisible drywall patching and ceiling repair for Lake Shore homeowners.",
		type: "website",
		images: [
			{
...
export default function LakeShoreDrywallRepairPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Professional drywall patching and ceiling repair in Lake Shore WA 98660"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">in Lake Shore</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Precision Texture Matching for Lake Shore Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Many Lake Shore properties feature Orange Peel or Knockdown textures. Our
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								icon: Paintbrush,
								desc: "Hand-finished texture common in Lake Shore homes.",
							},
							{
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide drywall repair throughout Lake Shore, including Felida, Salmon Creek North, Rosemont, and surrounding Clark County
						neighborhoods.
					</p>
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Lake Shore Drywall Repair FAQs
					</h2>
