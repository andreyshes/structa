...
export const metadata = {
	title:
		"Door & Window Repair Hazel Dell WA (98665) | Alignment & Draft Fix | Norbilt Homes",
	description:
		"Professional door alignment and window repair in Hazel Dell, Vancouver WA 98665. Fix sticking doors, drafts, weatherstripping, and lock issues. Licensed & insured. Free estimates.",
	alternates: {
		canonical: "https://norbilt.com/locations/hazel-dell-door-window-repair",
	},
	openGraph: {
		title: "Hazel Dell Door & Window Repair | Vancouver WA 98665",
		description:
			"Expert door adjustments, draft sealing, and hardware repair for Hazel Dell homeowners.",
		type: "website",
		images: [
			{
...
export default function HazelDellDoorWindowPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Door alignment and window sealing repair in Hazel Dell Vancouver WA 98665"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<p className="text-xl mb-10 text-white/90 max-w-2xl mx-auto">
						...
						Precision adjustments for established 98665 homes.
					</p>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					...
					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Settling foundations and Pacific Northwest seasonal shifts can cause
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Hazel Dell Door & Window Repair Services
					</h2>
					...
					<div className="grid md:grid-cols-3 gap-8 text-center">
						...
						<div className="p-8 rounded-2xl bg-white shadow-sm hover:shadow-lg transition group">
							...
							<p className="text-sm text-[#2C3E3A]/70">
								Stop drafts and improve energy efficiency in your 98665 home.
							</p>
						</div>
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide door and window repair throughout Hazel Dell (98665),
						Starcrest, Minnehaha, Salmon Creek, and surrounding Vancouver WA
						neighborhoods.
					</p>
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Hazel Dell Door & Window FAQs
					</h2>

					<div className="space-y-10">
						<div>
							<h3 className="font-semibold text-lg">
								Why do doors stick in older Hazel Dell homes?
							</h3>
							<p className="text-[#2C3E3A]/70 mt-2">
								Foundation movement and seasonal humidity changes can cause
								slight frame shifts. Proper alignment corrects the issue
								long-term.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. Proper weatherstripping and sealing reduce air leakage and
