...
export const metadata = {
	title:
		"Door & Window Repair Felida WA (98660) | Draft & Alignment Fix | Norbilt",
	description:
		"Professional door and window repair in Felida, WA 98660. Fix sticking doors, drafts, weatherstripping, lock issues, and frame misalignment. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/felida/door-window",
	},
	openGraph: {
		title: "Felida Door & Window Repair | 98660 Alignment & Draft Fix",
		description:
			"Precision door adjustments, window sealing, and hardware repair for Felida homeowners.",
		type: "website",
		images: [
			{
...
export default function FelidaDoorWindowPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Door alignment and window sealing repair in Felida Washington 98660"
					fill
					priority
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide door and window repair throughout Felida, including
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Felida Door & Window FAQs
					</h2>

					<div className="space-y-10">
						<div>
							<h3 className="font-semibold text-lg">
								Why do doors stick in Felida homes?
							</h3>
