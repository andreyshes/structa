...
export const metadata = {
	title:
		"Drywall Repair Washougal WA (98671) | Texture Matching & Ceiling Repair | Norbilt",
	description:
		"Professional drywall repair in Washougal, WA 98671. We patch holes, repair cracks, fix ceiling water damage, and match Orange Peel or Knockdown textures with seamless results.",
	alternates: {
		canonical: "https://norbilt.com/locations/washougal/drywall-repair",
	},
	openGraph: {
		title: "Washougal Drywall Repair & Texture Matching | 98671",
		description:
			"Invisible drywall patching and ceiling repair for Washougal homeowners.",
		type: "website",
		images: [
			{
...
export default function WashougalDrywallRepairPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Professional drywall patching and ceiling repair in Washougal WA 98671"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">in Washougal</span>
					</h1>

					<p className="text-xl md:text-2xl mb-10 text-white/90 max-w-2xl mx-auto">
						Invisible patching, seamless texture blending, and professional
						ceiling restoration for 98671 homes.
					</p>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Precision Texture Matching for Washougal Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Many Washougal properties feature Orange Peel or Knockdown textures. Our
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6 text-center">
					<h2 className="text-4xl font-bold mb-14">
						Texture Matching Services in 98671
					</h2>
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								icon: Paintbrush,
								desc: "Hand-finished texture common in Washougal homes.",
							},
							{
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide drywall repair throughout Washougal, including Parker's Landing, Hathaway Park, Cape Horn, and surrounding Clark County
						neighborhoods.
					</p>
