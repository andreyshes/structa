...
export default function DrywallRepairCostClarkCountyWA() {
	return (
		<>
			<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BlogPosting", headline: "Drywall Repair Cost in Clark County WA: 2026 Guide", author: { "@id": "https://www.norbilt.com/#founder" }, publisher: { "@id": "https://www.norbilt.com/#organization" }, datePublished: "2026-06-08", dateModified: "2026-06-08", mainEntityOfPage: "https://www.norbilt.com/blog/drywall-repair-cost-clark-county-wa" }) }} />
			<script
			...
			<div className="overflow-hidden bg-[#FDFCFB]">
				...
				<article className="py-16 lg:py-24">
					<div className="max-w-3xl mx-auto px-6 lg:px-8 space-y-16">
						<section className="space-y-5 text-gray-700 leading-relaxed text-lg"><p>Drywall repair in Clark County WA costs between <strong>$175 for a small nail hole patch</strong> and <strong>$4,000+ for full room replacement</strong>. The range is wide because texture matching, moisture damage, and room access all significantly affect the scope.</p><p>NORBILT is a licensed general contractor (WA Lic. <strong>NORBIHH849QC</strong>) serving all of Clark County. We back all drywall work with a 1-year workmanship warranty. $1,000,000 liability insurance.</p></section>
