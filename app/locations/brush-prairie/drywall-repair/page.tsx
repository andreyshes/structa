...
export const metadata = {
	title:
		"Drywall Repair Brush Prairie WA (98606) | Texture Matching & Ceiling Repair | Norbilt",
	description:
		"Professional drywall repair in Brush Prairie, WA 98606. Patch holes, repair cracks, fix ceiling water damage, and match Orange Peel or Knockdown textures seamlessly. Licensed & insured.",
	alternates: {
		canonical: "https://norbilt.com/locations/brush-prairie/drywall-repair",
	},
	openGraph: {
		title: "Brush Prairie Drywall Repair | Texture Matching 98606",
		description:
			"Invisible drywall patching and ceiling repair for Brush Prairie homeowners.",
		type: "website",
		images: [
			{
...
export default function BrushPrairieDrywallRepairPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					src="https://t3.ftcdn.net/jpg/07/02/00/06/240_F_702000603_TbsdkNFiCwyNSCsDFX2PmgQ5NKyRuQnW.jpg"
					alt="Professional drywall repair and ceiling patching in Brush Prairie WA 98606"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<p className="text-xl md:text-2xl mb-10 text-white/90 max-w-2xl mx-auto">
						...
						ceiling restoration for 98606 homes.
					</p>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Precision Texture Matching for 98606 Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Many Brush Prairie homes feature Orange Peel or Knockdown textures.
						Our feathering and blending technique ensures repairs disappear into
						your existing walls or ceilings.
					</p>

					<div className="grid md:grid-cols-3 gap-8 mt-14">
						{[
							"Dust-Controlled Work Areas",
							"Feathered Edges & Seamless Blending",
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6 text-center">
					<h2 className="text-4xl font-bold mb-14">
						Texture Matching Services in Brush Prairie
					</h2>
					...
					<div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								icon: Paintbrush,
								desc: "Hand-finished texture common in 98606 homes.",
							},
							{
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide drywall repair services throughout Brush Prairie,
