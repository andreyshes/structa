...
export const metadata = {
	title: "Flooring & Subfloor Repair Washougal WA (98671) | Norbilt",
	description:
		"Professional flooring repair in Washougal, WA 98671. Fix squeaky floors, uneven subfloors, moisture damage, and hardwood or LVP transitions. Licensed & insured. Free estimates.",
	alternates: {
		canonical: "https://norbilt.com/locations/washougal/flooring",
	},
	openGraph: {
		title: "Washougal Flooring Repair | Subfloor & Leveling 98671",
		description:
			"Expert floor leveling, squeak repair, and structural flooring corrections for Washougal homeowners.",
		type: "website",
		images: [
			{
...
export default function WashougalFlooringPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Hardwood and subfloor repair in Washougal Washington 98671"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						Flooring & Subfloor
						<span className="block text-[#A5D6A7]">Repair in Washougal</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Structural Flooring Corrections for 98671 Homes
					</h2>

					<p className="text-lg text-[#2C3E3A]/80 max-w-3xl mx-auto">
						Washougal homes experience seasonal expansion and moisture shifts. We address
			...
			<section className="py-24 bg-[#E8E4DE]">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Washougal Flooring Repair Services
					</h2>
			...
			<section className="py-20 text-center bg-white">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-[#2C3E3A]/70 mb-10">
						We provide flooring repair services throughout Washougal, including
						Parker's Landing, Hathaway Park, Cape Horn, and surrounding Clark
			...
			<section className="py-24 bg-[#F8F6F3]">
				<div className="max-w-5xl mx-auto px-6">
					<h2 className="text-4xl font-bold text-center mb-14">
						Washougal Flooring FAQs
					</h2>

					<div className="space-y-10">
						<div>
							<h3 className="font-semibold text-lg">
								Why do floors squeak in Washougal homes?
							</h3>
