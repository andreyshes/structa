...
export const metadata = {
	title: "Kitchen & Bathroom Remodeling Felida WA (98660) | Norbilt",
	description:
		"Premium kitchen and bathroom updates in Felida, WA 98660. Designer fixture upgrades, backsplash installation, cabinet refinements, and luxury finish improvements without full demolition.",
	alternates: {
		canonical: "https://norbilt.com/locations/felida/kitchen-bath",
	},
	openGraph: {
		title: "Felida Kitchen & Bathroom Updates | 98660 Remodeling",
		description: "Refined kitchen and bath modernization for Felida homeowners.",
		type: "website",
		images: [
			{
...
export default function FelidaKitchenBathPage() {
	return (
		<div className="overflow-hidden bg-[#F8F6F3] text-[#2C3E3A]">
			...
			<section className="relative pt-44 pb-40 flex items-center justify-center text-center bg-[#1F2E2B]">
				<Image
					...
					alt="Luxury kitchen remodel update in Felida Washington 98660"
					fill
					priority
				...
				<div className="relative z-10 max-w-4xl px-6 text-white">
					...
					<h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
						...
						<span className="block text-[#A5D6A7]">Updates in Felida</span>
					</h1>
			...
			<section className="py-20 bg-white text-center">
				<div className="max-w-6xl mx-auto px-6">
					<h2 className="text-4xl font-bold mb-6">
						Felida Kitchen & Bath Modernization Specialists
					</h2>

					<p className="max-w-3xl mx-auto text-lg text-[#2C3E3A]/80 leading-relaxed">
						From Felida homes to surrounding properties, we
					...
					<div className="space-y-8">
						<div>
							<h2 className="text-4xl font-bold mb-4">
								Felida Kitchen & Bathroom Upgrade Services
							</h2>
					...
					<div className="relative group">
						...
						<div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
							<Image
								...
								alt="Bathroom upgrade in Felida Washington home"
								fill
			...
			<section className="bg-[#1F2E2B] text-white py-20 text-center">
				<div className="max-w-4xl mx-auto px-6">
					...
					<p className="text-white/80 leading-relaxed">
						We serve Felida neighborhoods including Salmon Creek, Rosemont, Lake Shore, and surrounding Clark County areas.
					</p>
			...
			<section className="py-24 bg-white">
				<div className="max-w-5xl mx-auto px-6">
					...
					<div className="space-y-10">
						...
						<div>
							<h3 className="font-semibold text-lg">
								Do you serve all of Felida?
							</h3>
							<p className="text-[#2C3E3A]/70 mt-2">
								Yes. We serve Felida (98660) and surrounding Clark County
								neighborhoods.
							</p>
						</div>
					</div>
