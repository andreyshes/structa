...
const posts = [
	...
	{
		slug: "drywall-repair-cost-clark-county-wa",
		title: "Drywall Repair Cost in Clark County WA: 2026 Pricing Guide",
		excerpt: "How much does drywall repair cost in Clark County WA? Real 2026 price ranges for nail holes, cracks, water damage, and full panel replacements — plus city-by-city breakdowns.",
		category: "Cost Guide",
		location: "Clark County, WA",
		readTime: "7 min read",
	},
	{
		slug: "bathroom-remodel-cost-battle-ground-wa",
		title: "Bathroom Remodel Cost in Battle Ground WA: 2026 Pricing Guide",
		excerpt: "How much does a bathroom remodel cost in Battle Ground WA? Real 2026 price ranges for every scope — cosmetic refresh to full gut — plus Battle Ground-specific pricing factors.",
		category: "Cost Guide",
		location: "Battle Ground, WA",
		readTime: "7 min read",
	},
	{
		slug: "kitchen-remodel-cost-battle-ground-wa",
		title: "Kitchen Remodel Cost in Battle Ground WA: 2026 Pricing Guide",
		excerpt: "How much does a kitchen remodel cost in Battle Ground WA? Real 2026 price ranges — from a cosmetic refresh to a full custom build — plus Battle Ground neighborhood notes.",
		category: "Cost Guide",
		location: "Battle Ground, WA",
		readTime: "7 min read",
	},
	{
		slug: "kitchen-remodel-cost-ridgefield-wa",
		title: "Kitchen Remodel Cost in Ridgefield WA: 2026 Pricing Guide",
		excerpt: "How much does a kitchen remodel cost in Ridgefield WA? Real 2026 price ranges for every scope — cosmetic refresh to full custom build — plus Ridgefield-specific pricing factors.",
		category: "Cost Guide",
		location: "Ridgefield, WA",
		readTime: "7 min read",
	},
	{
		slug: "bathroom-remodel-cost-camas-wa",
		title: "Bathroom Remodel Cost in Camas WA: 2026 Pricing Guide",
		excerpt: "How much does a bathroom remodel cost in Camas WA? Real 2026 price ranges for every scope — cosmetic refresh to full primary suite gut — plus Camas neighborhood breakdowns.",
		category: "Cost Guide",
		location: "Camas, WA",
		readTime: "7 min read",
	},
